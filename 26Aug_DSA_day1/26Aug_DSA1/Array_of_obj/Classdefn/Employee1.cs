...
namespace Classdefn
{
    public class Employee1
    {
        ...
        private string _ename;  // private for secure
        ...
        public double GrossSalary { get; private set; }  // private:we r not getting i/p from                                       user: only from class assignment it happens,secure..
